...
public class ClassController {
    ...
    public ResponseEntity<ClassDao> getClassById(
    ...
    public ResponseEntity<List<ClassDao>> getClassesInCourse(
            @PathVariable Integer departmentId,
            @PathVariable Integer courseId) {
    ...
    public ResponseEntity<List<ClassDao>> getClassesInDepartment(@PathVariable Integer departmentId) {
        return ResponseEntity.ok(classService.getClassesInDepartment(departmentId));
    }

    // Get all courses for a collage
    @GetMapping("/class")
    public ResponseEntity<List<ClassDao>> getAllClasses() {
    ...
    public ResponseEntity<String> addCourse(
        ...
        if (isAdded) {
            ...
            return new ResponseEntity<>("A Class already exists at the same time and room!", HttpStatus.CONFLICT);
        }
    }
